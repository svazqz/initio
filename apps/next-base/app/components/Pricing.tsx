...
const Pricing = () => {
  return (
    <div
      className="px-5 lg:px-0 lg:container pt-14 sm:pt-32 mb-11"
      id="pricing"
    >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-4 text-[16px] lg:text-[18px] text-primary">
                <Image fill src={Check} alt="check" /> Lorem ipsum dolor sit
                amet
              </li>
              <li className="flex items-center gap-4 text-[16px] lg:text-[18px] text-primary">
                <Image fill src={Check} alt="check" /> Consectetur adipiscing
                elit
              </li>
              <li className="flex items-start gap-4 text-[16px] lg:text-[18px] text-primary">
                <Image fill src={Check} alt="check" /> Sed do eiusmod tempor
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-4 text-[16px] lg:text-[18px] text-[#F4F8FA]">
                <Image fill src={CheckWhite} alt="check" /> Lorem ipsum dolor
                sit amet
              </li>
              <li className="flex items-center gap-4 text-[16px] lg:text-[18px] text-[#F4F8FA]">
                <Image fill src={CheckWhite} alt="check" /> Consectetur
                adipiscing elit
              </li>
              <li className="flex items-start gap-4 text-[16px] lg:text-[18px] text-[#F4F8FA]">
                <Image fill src={CheckWhite} alt="check" /> Sed do eiusmod
